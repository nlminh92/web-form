...
export class ListCurriculumsComponent implements OnInit {
  ...
  exportExcel() {
      ...
      headerRow.eachCell((cell, number) => {
          ...
          worksheet.getColumn(62).width = 50;
          ...
          worksheet.getColumn(70).width = 50;
          worksheet.getColumn(71).width = 20;
          ...
          worksheet.getColumn(86).width = 50;
          ...
          worksheet.getColumn(154).width = 50;
