...
async function getData(item) {
    ...
    let data = {
        ...
        option1: item.option1 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option2: item.option2 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option3: item.option3 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option4: item.option4 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option5: item.option5 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option6: item.option6 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option7: item.option7 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option8: item.option8 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option9: item.option9 == "ca nam" ? "Cả năm" : "Học kỳ 1",
        option10: item.option10 == "ca nam" ? "Cả năm" : "Học kỳ 1",
